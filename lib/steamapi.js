...
async function getAchievements(steamid, appid) {
    ...
    const result = achievements.filter((a) => a.achieved = 1);
    return result;
}
...
async function checkAchievements(steamid, appid) {
  ...
  // console.log(playerAchievements("7656119833749383176561198337493831",367520));
...
module.exports = { getfriendIDs, getPlayerProfiles, getOwnedGames, checkAchievements };
